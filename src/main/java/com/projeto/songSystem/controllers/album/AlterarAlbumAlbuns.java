...
@Controller
@RequestMapping()
public class AlterarAlbumAlbuns {
    ...
    @PostMapping("/biblioteca/albuns/alteraralbum")
    public String alterarAlbum(@ModelAttribute("albumDTO") AlbumDTO albumDTO, RedirectAttributes attributes) {
        try{

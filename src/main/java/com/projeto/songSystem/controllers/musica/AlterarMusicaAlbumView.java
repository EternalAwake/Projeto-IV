...
@Controller
@RequestMapping()
public class AlterarMusicaAlbumView {
    ...
    @GetMapping("/biblioteca/albuns/visualizar/visualizarmusica/alterarmusica/{id}")
    public String exibirCadastrarMusica(Model model, HttpSession session, @PathVariable Long id) {
        ...
        return "AlterarMusicaAlbumView";
    }

    @PostMapping("/biblioteca/albuns/visualizar/visualizarmusica/alterarmusica")
    public String alterarMusica(@ModelAttribute("musica") MusicaDTO musicaDTO,
        ...
        return "redirect:/biblioteca/albuns/visualizar/visualizarmusica/alterarmusica/" + musicaDTO.getMusicaId();
    }

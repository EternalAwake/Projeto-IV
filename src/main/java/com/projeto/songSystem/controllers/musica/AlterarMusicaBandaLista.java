...
@Controller
@RequestMapping()
public class AlterarMusicaBandaLista {
    ...
    public String exibirAlterarMusica(Model model, HttpSession session, @PathVariable Long id) {
        ...
        return "AlterarMusicaBandaLista";
    }

    @PostMapping("/biblioteca/bandas/visualizar/alterarmusica")
    public String alterarMusica(@ModelAttribute("musica") MusicaDTO musicaDTO,
        ...
        return "redirect:/biblioteca/bandas/visualizar/alterarmusica/" + musicaDTO.getMusicaId();
    }

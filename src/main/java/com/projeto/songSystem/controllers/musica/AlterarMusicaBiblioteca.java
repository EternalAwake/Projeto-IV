...
@Controller
@RequestMapping()
public class AlterarMusicaBiblioteca {
    ...
    @GetMapping("/biblioteca/alterarmusica/{id}")
    public String exibirCadastrarMusica(Model model, HttpSession session, @PathVariable Long id) {
        ...
        return "AlterarMusicaBiblioteca";
    }

    @PostMapping("/biblioteca/alterarmusica")
    public String alterarMusica(@ModelAttribute("musica") MusicaDTO musicaDTO,
        ...
        return "redirect:/biblioteca/alterarmusica/" + musicaDTO.getMusicaId();
    }

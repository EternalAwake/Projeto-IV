...
@Controller
@RequestMapping()
public class AlterarMusicaController {
    ...
    @GetMapping("/biblioteca/musicas/visualizarmusica/alterarmusica/{id}")
    public String exibirCadastrarMusica(Model model, HttpSession session, @PathVariable Long id) {
        ...
        return "AlterarMusica";
    }

    @PostMapping("/biblioteca/musicas/visualizarmusica/alterarmusica")
    public String alterarMusica(@ModelAttribute("musica") MusicaDTO musicaDTO,
        ...
        return "redirect:/biblioteca/musicas/visualizarmusica/alterarmusica/" + musicaDTO.getMusicaId();
    }

...
@Controller
@RequestMapping()
public class AlterarBandaBandas {
    ...
    public String exibirAlterarBanda(Model model, HttpSession session, @PathVariable Long id) {
        ...
        return "AlterarBandaBandas";
    }

    @PostMapping("/biblioteca/bandas/alterarbanda")
    public String alterarBanda(@ModelAttribute("banda") BandaDTO bandaDTO, RedirectAttributes attributes) {
        try{
